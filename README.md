# Connectedcars.io (AU Volkswagen)

[![hacs_badge](https://img.shields.io/badge/HACS-Custom-orange.svg)](https://github.com/custom-components/hacs)

The `Connectedcars.io (AU Volkswagen)` component is a Home Assistant custom component for showing car information for Australian Volkswagens equipped with the hardware to send data to the mobile app "Go Connect"
...
3. Search for and install the `Connectedcars.io (AU Volkswagen)` integration.
...
2. Add new and search for `Connectedcars.io (AU Volkswagen)`
...
_So far only tested with a single car_
...
- Ignition
- Lamp _+name_ (one sensor per each reported lamp, disabled by default)
...
All sensors may not be reported correctly with all cars.
...
logger:
  default: info
  logs:
    custom_components.connectedcars_io_au: debug
```

## Examples

Configuration  
![Config](https://github.com/whahoo/homeassistant-connectedcars_io/raw/main/images/config.png)  
![Options](https://github.com/whahoo/homeassistant-connectedcars_io/raw/main/images/options.png)

Device  
![Device](https://github.com/whahoo/homeassistant-connectedcars_io/raw/main/images/device.png)

Dashboard  
![Dashboard](https://github.com/whahoo/homeassistant-connectedcars_io/raw/main/images/dashboard.png)

Location state  
![Location state](https://github.com/whahoo/homeassistant-connectedcars_io/raw/main/images/location_state.png)
